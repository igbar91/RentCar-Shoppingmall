...
%>
	<tr height="30" align="center" class="tableInfo" >
		...
		<td  width="300">
		<a href="RentCarMain.jsp?center=./boardArrangedFolder/BoardMain.jsp?list=BoardInfo.jsp?num=<%=bean.getNum()%>">
...
<tr height="30">
	<td colspan="5" class="sending" align="right">	
		...
		<input type="button" value="글쓰기" onclick="location.href='RentCarMain.jsp?center=./boardArrangedFolder/BoardMain.jsp?list=BoardWriteForm.jsp'">
		</td>
	</tr>
</table>
